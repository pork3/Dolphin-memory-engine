...
QT_MOC_LITERAL(5, 45, 30), // "Common::MemOperationReturnCode"
QT_MOC_LITERAL(6, 76, 11), // "writeReturn"
QT_MOC_LITERAL(7, 88, 10), // "readFailed"
QT_MOC_LITERAL(8, 99, 13) // "dropSucceeded"

    },
    "MemWatchModel\0writeFailed\0\0QModelIndex\0"
    "index\0Common::MemOperationReturnCode\0"
...
void MemWatchModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MemWatchModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MemWatchModel::*)(const QModelIndex & , Common::MemOperationReturnCode );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MemWatchModel::writeFailed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MemWatchModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MemWatchModel::readFailed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MemWatchModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MemWatchModel::dropSucceeded)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MemWatchModel::staticMetaObject = { {
    &QAbstractItemModel::staticMetaObject,
    qt_meta_stringdata_MemWatchModel.data,
    qt_meta_data_MemWatchModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
