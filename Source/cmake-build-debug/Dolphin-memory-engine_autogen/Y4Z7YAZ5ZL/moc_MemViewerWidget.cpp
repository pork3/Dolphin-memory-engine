...
QT_MOC_LITERAL(3, 28, 17), // "addWatchRequested"
QT_MOC_LITERAL(4, 46, 14), // "MemWatchEntry*"
QT_MOC_LITERAL(5, 61, 5) // "entry"

    },
    "MemViewerWidget\0mustUnhook\0\0"
    "addWatchRequested\0MemWatchEntry*\0entry"
};
...
void MemViewerWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MemViewerWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mustUnhook(); break;
        case 1: _t->addWatchRequested((*reinterpret_cast< MemWatchEntry*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MemViewerWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MemViewerWidget::mustUnhook)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MemViewerWidget::*)(MemWatchEntry * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MemViewerWidget::addWatchRequested)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MemViewerWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_MemViewerWidget.data,
    qt_meta_data_MemViewerWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 1
void MemViewerWidget::addWatchRequested(MemWatchEntry * _t1)
{
